 ...
 */
#define MAIDL_HASH ((int)0xe8772ff2)
...
#pragma pack(pop)
#endif
typedef struct MAPurchaseEventDataNative {
	/**
	* \brief Type of the purchase event.
	* One of the \link MA_PURCHASE_EVENT_REQUEST MA_PURCHASE_EVENT \endlink constants.
	*/
...
maIOCtl_maFileSetProperty_case(maFileSetProperty) \
...
maIOCtl_maIapSave_case(maIapSave) \
maIOCtl_maIapReset_case(maIapReset) \
maIOCtl_maIapShutdown_case(maIapShutdown) \
maIOCtl_maNetworkStatus_case(maNetworkStatus) \
maIOCtl_maIapSetMethod_case(maIapSetMethod) \
maIOCtl_maIapSetFilter_case(maIapSetFilter) \
...
maIOCtl_maCameraPreviewSize_case(maCameraPreviewSize) \
maIOCtl_maCameraPreviewEventEnable_case(maCameraPreviewEventEnable) \
maIOCtl_maCameraPreviewEventDisable_case(maCameraPreviewEventDisable) \
maIOCtl_maCameraPreviewEventConsumed_case(maCameraPreviewEventConsumed) \
...
maIOCtl_maAutostartOn_case(maAutostartOn) \
maIOCtl_maAutostartOff_case(maAutostartOff) \
...
maIOCtl_maImagePickerOpenWithEventReturnType_case(maImagePickerOpenWithEventReturnType) \
...
maIOCtl_maNFCGetId_case(maNFCGetId) \
...
maIOCtl_maAudioInstanceCreateDynamic_case(maAudioInstanceCreateDynamic) \
maIOCtl_maAudioSubmitBuffer_case(maAudioSubmitBuffer) \
maIOCtl_maAudioGetPendingBufferCount_case(maAudioGetPendingBufferCount) \
...
maIOCtl_maPurchaseSupported_case(maPurchaseSupported) \
maIOCtl_maPurchaseCreate_case(maPurchaseCreate) \
maIOCtl_maPurchaseSetPublicKey_case(maPurchaseSetPublicKey) \
maIOCtl_maPurchaseRequest_case(maPurchaseRequest) \
maIOCtl_maPurchaseVerifyReceipt_case(maPurchaseVerifyReceipt) \
maIOCtl_maPurchaseGetField_case(maPurchaseGetField) \
maIOCtl_maPurchaseSetStoreURL_case(maPurchaseSetStoreURL) \
maIOCtl_maPurchaseGetName_case(maPurchaseGetName) \
maIOCtl_maPurchaseRestoreTransactions_case(maPurchaseRestoreTransactions) \
maIOCtl_maPurchaseDestroy_case(maPurchaseDestroy) \
...
maIOCtl_syscall_case(maFileSetProperty) \
...
maIOCtl_syscall_case(maCameraPreviewSize) \
maIOCtl_syscall_case(maCameraPreviewEventEnable) \
maIOCtl_syscall_case(maCameraPreviewEventDisable) \
maIOCtl_syscall_case(maCameraPreviewEventConsumed) \
...
maIOCtl_syscall_case(maAutostartOn) \
maIOCtl_syscall_case(maAutostartOff) \
...
maIOCtl_syscall_case(maImagePickerOpenWithEventReturnType) \
...
maIOCtl_syscall_case(maNFCGetId) \
...
maIOCtl_syscall_case(maAudioInstanceCreateDynamic) \
maIOCtl_syscall_case(maAudioSubmitBuffer) \
maIOCtl_syscall_case(maAudioGetPendingBufferCount) \
...
maIOCtl_syscall_case(maPurchaseSupported) \
maIOCtl_syscall_case(maPurchaseCreate) \
maIOCtl_syscall_case(maPurchaseSetPublicKey) \
maIOCtl_syscall_case(maPurchaseRequest) \
maIOCtl_syscall_case(maPurchaseVerifyReceipt) \
maIOCtl_syscall_case(maPurchaseGetField) \
maIOCtl_syscall_case(maPurchaseSetStoreURL) \
maIOCtl_syscall_case(maPurchaseGetName) \
maIOCtl_syscall_case(maPurchaseRestoreTransactions) \
maIOCtl_syscall_case(maPurchaseDestroy) \
...
#define maIOCtl_maFileSetProperty 60
#define maIOCtl_maFileSetProperty_case(func) \
case 60: \
{ \
const char* _path = GVS(a); \
int _property = b; \
int _value = c; \
return func(_path, _property, _value); \
} \

#define maIOCtl_maSendTextSMS 61
...
#define maIOCtl_maFrameBufferGetInfo 79
...
#define maIOCtl_maFrameBufferInit 80
...
#define maIOCtl_maFrameBufferClose 81
...
#define maIOCtl_maSendToBackground 86
...
#define maIOCtl_maBringToForeground 87
...
#define maIOCtl_maGetSystemProperty 89
...
#define maIOCtl_maIapSave 90
#define maIOCtl_maIapSave_case(func) \
case 90: \
{ \
return func(); \
} \

#define maIOCtl_maIapReset 91
#define maIOCtl_maIapReset_case(func) \
case 91: \
{ \
return func(); \
} \

#define maIOCtl_maIapShutdown 92
#define maIOCtl_maIapShutdown_case(func) \
case 92: \
{ \
return func(); \
} \

#define maIOCtl_maNetworkStatus 93
#define maIOCtl_maNetworkStatus_case(func) \
case 93: \
{ \
return func(); \
} \

#define maIOCtl_maIapSetMethod 94
#define maIOCtl_maIapSetMethod_case(func) \
case 94: \
{ \
int _type = a; \
return func(_type); \
...
#define maIOCtl_maIapSetFilter 95
#define maIOCtl_maIapSetFilter_case(func) \
case 95: \
{ \
int _filter = a; \
return func(_filter); \
...
#define maIOCtl_maCameraFormatNumber 127
...
#define maIOCtl_maCameraFormat 128
...
#define maIOCtl_maCameraStart 129
...
#define maIOCtl_maCameraStop 130
...
#define maIOCtl_maCameraSetPreview 131
...
#define maIOCtl_maCameraSelect 132
...
#define maIOCtl_maCameraNumber 133
...
#define maIOCtl_maCameraSnapshot 134
...
#define maIOCtl_maCameraRecord 135
...
#define maIOCtl_maCameraSetProperty 136
...
#define maIOCtl_maCameraGetProperty 137
...
#define maIOCtl_maCameraPreviewSize 138
#define maIOCtl_maCameraPreviewSize_case(func) \
case 138: \
{ \
return func(); \
} \

#define maIOCtl_maCameraPreviewEventEnable 139
#define maIOCtl_maCameraPreviewEventEnable_case(func) \
case 139: \
{ \
int _previewEventType = a; \
void* _previewBuffer = GVMR(b, MAAddress); \
const MARect* _previewArea = GVMR(c, MARect); \
return func(_previewEventType, _previewBuffer, _previewArea); \
} \

#define maIOCtl_maCameraPreviewEventDisable 140
#define maIOCtl_maCameraPreviewEventDisable_case(func) \
case 140: \
{ \
return func(); \
} \

#define maIOCtl_maCameraPreviewEventConsumed 141
#define maIOCtl_maCameraPreviewEventConsumed_case(func) \
case 141: \
{ \
return func(); \
} \

#define maIOCtl_maShowVirtualKeyboard 142
...
#define maIOCtl_maKeyCaptureStart 144
...
#define maIOCtl_maKeyCaptureStop 145
...
#define maIOCtl_maHomeScreenEventsOn 146
...
#define maIOCtl_maHomeScreenEventsOff 147
...
#define maIOCtl_maHomeScreenShortcutAdd 148
...
#define maIOCtl_maHomeScreenShortcutRemove 149
...
#define maIOCtl_maNotificationAdd 150
...
#define maIOCtl_maNotificationRemove 151
...
#define maIOCtl_maScreenSetOrientation 152
...
#define maIOCtl_maScreenSetFullscreen 153
...
#define maIOCtl_maAutostartOn 154
#define maIOCtl_maAutostartOn_case(func) \
case 154: \
{ \
return func(); \
} \

#define maIOCtl_maAutostartOff 155
#define maIOCtl_maAutostartOff_case(func) \
case 155: \
{ \
return func(); \
} \

#define maIOCtl_maScreenSetSupportedOrientations 156
...
#define maIOCtl_maScreenGetSupportedOrientations 157
...
#define maIOCtl_maScreenGetCurrentOrientation 158
...
#define maIOCtl_maScreenStateEventsOn 159
...
#define maIOCtl_maScreenStateEventsOff 160
...
#define maIOCtl_maReportResourceInformation 410
...
#define maIOCtl_maMessageBox 411
...
#define maIOCtl_maImagePickerOpen 413
...
#define maIOCtl_maImagePickerOpenWithEventReturnType 414
#define maIOCtl_maImagePickerOpenWithEventReturnType_case(func) \
case 414: \
{ \
int _eventReturnType = a; \
func(_eventReturnType); \
return 0; \
} \

#define maIOCtl_maOptionsBox 415
...
#define maIOCtl_maSensorStart 416
...
#define maIOCtl_maSensorStop 417
...
#define maIOCtl_maNFCReadTag 420
...
#define maIOCtl_maNFCDestroyTag 421
...
#define maIOCtl_maNFCConnectTag 422
...
#define maIOCtl_maNFCCloseTag 423
...
#define maIOCtl_maNFCIsType 424
...
#define maIOCtl_maNFCGetTypedTag 425
...
#define maIOCtl_maNFCBatchStart 426
...
#define maIOCtl_maNFCBatchCommit 427
...
#define maIOCtl_maNFCBatchRollback 428
...
#define maIOCtl_maNFCTransceive 429
...
#define maIOCtl_maNFCSetReadOnly 430
...
#define maIOCtl_maNFCIsReadOnly 431
...
#define maIOCtl_maNFCGetSize 432
...
#define maIOCtl_maNFCGetId 433
#define maIOCtl_maNFCGetId_case(func) \
case 433: \
{ \
MAHandle _tag = (MAHandle)a; \
void* _dst = GVMR(b, MAAddress); \
int _len = c; \
return func(_tag, _dst, _len); \
} \

#define maIOCtl_maNFCReadNDEFMessage 434
...
#define maIOCtl_maNFCWriteNDEFMessage 435
...
#define maIOCtl_maNFCCreateNDEFMessage 436
...
#define maIOCtl_maNFCGetNDEFMessage 437
...
#define maIOCtl_maNFCGetNDEFRecord 438
...
#define maIOCtl_maNFCGetNDEFRecordCount 439
...
#define maIOCtl_maNFCGetNDEFId 440
...
#define maIOCtl_maNFCGetNDEFPayload 441
...
#define maIOCtl_maNFCGetNDEFTnf 442
...
#define maIOCtl_maNFCGetNDEFType 443
...
#define maIOCtl_maNFCSetNDEFId 444
...
#define maIOCtl_maNFCSetNDEFPayload 445
...
#define maIOCtl_maNFCSetNDEFTnf 446
...
#define maIOCtl_maNFCSetNDEFType 447
...
#define maIOCtl_maNFCAuthenticateMifareSector 448
...
#define maIOCtl_maNFCGetMifareSectorCount 449
...
#define maIOCtl_maNFCGetMifareBlockCountInSector 450
...
#define maIOCtl_maNFCMifareSectorToBlock 451
...
#define maIOCtl_maNFCReadMifareBlocks 452
...
#define maIOCtl_maNFCWriteMifareBlocks 453
...
#define maIOCtl_maNFCReadMifarePages 454
...
#define maIOCtl_maNFCWriteMifarePages 455
...
#define maIOCtl_maDBExecSQL 458
...
#define maIOCtl_maDBExecSQLParams 459
...
#define maIOCtl_maDBCursorDestroy 460
...
#define maIOCtl_maDBCursorNext 461
...
#define maIOCtl_maDBCursorGetColumnData 462
...
#define maIOCtl_maDBCursorGetColumnText 463
...
#define maIOCtl_maDBCursorGetColumnInt 464
...
#define maIOCtl_maDBCursorGetColumnDouble 465
...
#define maIOCtl_maAudioDataCreateFromResource 466
...
#define maIOCtl_maAudioDataCreateFromURL 467
...
#define maIOCtl_maAudioDataDestroy 468
...
#define maIOCtl_maAudioInstanceCreate 469
...
#define maIOCtl_maAudioInstanceCreateDynamic 470
#define maIOCtl_maAudioInstanceCreateDynamic_case(func) \
case 470: \
{ \
int _sampleRate = a; \
int _numChannels = b; \
int _bufferSize = c; \
return func(_sampleRate, _numChannels, _bufferSize); \
} \

#define maIOCtl_maAudioSubmitBuffer 471
#define maIOCtl_maAudioSubmitBuffer_case(func) \
case 471: \
{ \
MAAudioInstance _instance = (MAAudioInstance)a; \
const void* _buffer = GVMR(b, MAAddress); \
int _numBytes = c; \
return func(_instance, _buffer, _numBytes); \
} \

#define maIOCtl_maAudioGetPendingBufferCount 472
#define maIOCtl_maAudioGetPendingBufferCount_case(func) \
case 472: \
{ \
MAAudioInstance _instance = (MAAudioInstance)a; \
...
#define maIOCtl_maAudioInstanceDestroy 473
...
#define maIOCtl_maAudioGetLength 474
...
#define maIOCtl_maAudioSetNumberOfLoops 475
...
#define maIOCtl_maAudioPrepare 476
...
#define maIOCtl_maAudioPlay 477
...
#define maIOCtl_maAudioSetPosition 478
...
#define maIOCtl_maAudioGetPosition 479
...
#define maIOCtl_maAudioSetVolume 480
...
#define maIOCtl_maAudioPause 481
...
#define maIOCtl_maAudioStop 482
...
#define maIOCtl_maSyscallPanicsEnable 483
...
#define maIOCtl_maSyscallPanicsDisable 484
...
#define maIOCtl_maAdsBannerCreate 485
...
#define maIOCtl_maAdsBannerDestroy 486
...
#define maIOCtl_maAdsAddBannerToLayout 487
...
#define maIOCtl_maAdsRemoveBannerFromLayout 488
...
#define maIOCtl_maAdsBannerSetProperty 489
...
#define maIOCtl_maAdsBannerGetProperty 490
...
#define maIOCtl_maNotificationLocalCreate 491
...
#define maIOCtl_maNotificationLocalDestroy 492
...
#define maIOCtl_maNotificationLocalSetProperty 493
...
#define maIOCtl_maNotificationLocalGetProperty 494
...
#define maIOCtl_maNotificationLocalSchedule 495
...
#define maIOCtl_maNotificationLocalUnschedule 496
...
#define maIOCtl_maNotificationPushRegister 497
#define maIOCtl_maNotificationPushRegister_case(func) \
case 497: \
{ \
MAHandle _pushNotificationTypes = (MAHandle)a; \
const char* _senderId = GVS(b); \
return func(_pushNotificationTypes, _senderId); \
} \

#define maIOCtl_maNotificationPushUnregister 498
...
#define maIOCtl_maNotificationPushGetRegistration 499
...
#define maIOCtl_maNotificationPushGetData 500
...
#define maIOCtl_maNotificationPushDestroy 501
...
#define maIOCtl_maNotificationSetIconBadge 502
...
#define maIOCtl_maNotificationGetIconBadge 503
...
#define maIOCtl_maNotificationPushSetTickerText 504
...
#define maIOCtl_maNotificationPushSetMessageTitle 505
...
#define maIOCtl_maNotificationPushSetDisplayFlag 506
...
#define maIOCtl_maCaptureSetProperty 507
...
#define maIOCtl_maCaptureGetProperty 508
...
#define maIOCtl_maCaptureAction 509
...
#define maIOCtl_maCaptureWriteImage 510
...
#define maIOCtl_maCaptureGetImagePath 511
...
#define maIOCtl_maCaptureGetVideoPath 512
...
#define maIOCtl_maCaptureDestroyData 513
...
#define maIOCtl_maPurchaseSupported 514
#define maIOCtl_maPurchaseSupported_case(func) \
case 514: \
{ \
return func(); \
} \

#define maIOCtl_maPurchaseCreate 515
#define maIOCtl_maPurchaseCreate_case(func) \
case 515: \
{ \
MAHandle _productHandle = (MAHandle)a; \
const char* _productID = GVS(b); \
func(_productHandle, _productID); \
return 0; \
} \

#define maIOCtl_maPurchaseSetPublicKey 516
#define maIOCtl_maPurchaseSetPublicKey_case(func) \
case 516: \
{ \
const char* _developerPublicKey = GVS(a); \
return func(_developerPublicKey); \
} \

#define maIOCtl_maPurchaseRequest 517
#define maIOCtl_maPurchaseRequest_case(func) \
case 517: \
{ \
MAHandle _productHandle = (MAHandle)a; \
int _quantity = b; \
func(_productHandle, _quantity); \
return 0; \
} \

#define maIOCtl_maPurchaseVerifyReceipt 518
#define maIOCtl_maPurchaseVerifyReceipt_case(func) \
case 518: \
{ \
MAHandle _productHandle = (MAHandle)a; \
func(_productHandle); \
...
#define maIOCtl_maPurchaseGetField 519
#define maIOCtl_maPurchaseGetField_case(func) \
case 519: \
{ \
MAHandle _productHandle = (MAHandle)a; \
const char* _property = GVS(b); \
int _bufferSize = SYSCALL_THIS->GetValidatedStackValue(0 VSV_ARGPTR_USE); \
char* _buffer = (MAString) SYSCALL_THIS->GetValidatedMemRange(c, _bufferSize); \
return func(_productHandle, _property, _buffer, _bufferSize); \
} \

#define maIOCtl_maPurchaseSetStoreURL 520
#define maIOCtl_maPurchaseSetStoreURL_case(func) \
case 520: \
{ \
const char* _url = GVS(a); \
func(_url); \
...
#define maIOCtl_maPurchaseGetName 521
#define maIOCtl_maPurchaseGetName_case(func) \
case 521: \
{ \
MAHandle _productHandle = (MAHandle)a; \
int _bufferSize = c; \
char* _buffer = (MAString) SYSCALL_THIS->GetValidatedMemRange(b, _bufferSize); \
return func(_productHandle, _buffer, _bufferSize); \
} \

#define maIOCtl_maPurchaseRestoreTransactions 522
#define maIOCtl_maPurchaseRestoreTransactions_case(func) \
case 522: \
{ \
func(); \
return 0; \
...
#define maIOCtl_maPurchaseDestroy 523
#define maIOCtl_maPurchaseDestroy_case(func) \
case 523: \
{ \
MAHandle _productHandle = (MAHandle)a; \
return func(_productHandle); \
} \
